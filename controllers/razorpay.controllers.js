...
// Fetch all orders
exports.fetchAllOrders = asyncHandler(async (_req, res) => {
...
exports.fetchOrderPayments = asyncHandler(async (req, res) => {
  const { orderId } = req.params;
...
exports.fetchPaymentById = asyncHandler(async (req, res) => {
  const { paymentId } = req.params;
...
// Fetch all payments
exports.fetchAllPayments = asyncHandler(async (_req, res) => {
...
exports.fetchPaymentCardDetails = asyncHandler(async (req, res) => {
  const { paymentId } = req.params;
...
exports.initiatePaymentRefund = asyncHandler(async (req, res) => {
  const { paymentId } = req.params;
  const { amount } = req.body;
...
exports.fetchMultipleRefundsOfPayment = asyncHandler(async (req, res) => {
  const { paymentId } = req.params;
...
exports.fetchSpecificRefundOfPayment = asyncHandler(async (req, res) => {
...
// Fetch all refunds
exports.fetchAllRefunds = asyncHandler(async (_req, res) => {
...
// Fetch refund by id
exports.fetchRefundById = asyncHandler(async (req, res) => {
...
exports.fetchAllSettlements = asyncHandler(async (_req, res) => {
...
exports.fetchSettlementById = asyncHandler(async (req, res) => {
...
exports.fetchSettlementReports = asyncHandler(async (req, res) => {
